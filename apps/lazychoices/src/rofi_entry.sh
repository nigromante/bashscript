...
webcam() {
    ...
    mplayer_devices
    choices -p "rofi" -o "mplayer_list" -vo "mplayer_device_selected" -T "Dispositivo\x20Webcam"
...
meses() {
    ...
    choices -p "menu" -o "aopts_meses" -l "albls_meses" -vo "salida" -T "Seleccione\x20Mes"
